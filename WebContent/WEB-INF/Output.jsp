<%@page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%><%-- These comments are to prevent excess whitespace in the output.
--%><%@page session="false"%><%--
...
<body>
	...
	<p><c:choose><c:when test='${ uniquessbean.value.equals("unique") }'>
		...
		Within our dataset of visitors, only <strong>one in <fmt:formatNumber value="${ uniquessbean.inX }" maxFractionDigits="0"/> browsers have the same fingerprint as yours.</strong>
